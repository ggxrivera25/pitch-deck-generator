...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    slideTitle: 'Market Size',
    slideNumber: 5,
    question: "What's your market size? Include TAM, SAM, and SOM if you have estimates. (Optional — AI will infer if left blank)",
    placeholder: 'e.g. TAM: $12B global restaurant ops software market. SAM: $2.1B US mid-market restaurants. SOM: $85M we can realistically capture in 5 years.',
    helpText: "Optional but helpful. TAM = total addressable market. SAM = serviceable segment. SOM = realistic target. If you skip this, the AI will infer market size from your industry, pricing, and target customer description using bottom-up methodology.",
    workshopHint: 'TAM / SAM / SOM (AI will infer if blank)',
    required: false,
    inputType: 'textarea',
  },

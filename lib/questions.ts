...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    slideTitle: 'Market Size',
    slideNumber: 5,
    question: "What's your market size? Include TAM, SAM, and SOM if possible. Estimates are OK.",
    ...
    helpText: 'TAM = total addressable market. SAM = serviceable (your actual segment). SOM = realistic target for your business. Use industry reports, company counts × ACV, or your own logic.',
    workshopHint: 'TAM / SAM / SOM estimates',
    required: true,
    inputType: 'textarea',
  },
